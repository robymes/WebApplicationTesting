...
describe("Given the user that wants to insert a new todo item", function () {
    var newTodoItemViewModel, todoListViewModel, eventBus, myTodoService, onNewTodoItemInsertedHandler;
    ...
    it("when a new todo item is inserted, then the form resets, and the item is remotely inserted, " +
        "and the item list is updated", function () {
        var dueDate, newTodoItem;
    ...
    it("when a new item is inserted, and remote service throws an error, then the form doesn't reset, " +
        "and an error is raised", function () {
        var dueDate, newTodoItem;
